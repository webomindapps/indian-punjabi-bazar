                ...
                <div class="row reverse align-items-center">
                    <div class="col-md-12 pt-5">
                        <div class="select-pickup">
                            <h2 class="text-left">Select Delivery or Pickup</h2>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <template v-if="deliveryType == 'delivery'">
                        ...
                        <div v-else>
                            ...
                            <p class="text-danger">Minimum $50</p>
                        </div>
                    </template>
                    <template v-else>
                        <a
...
const deliveryTypeLocation = ref(" Punjabi Bazaar");
...
watch(
    ...
    () => {
        ...
        if (deliveryType.value == "pickup") {
            deliveryTypeLocation.value = "Punjabi Bazar";

                    ...
                    <div class="form-card px-3">
                        @php
                            $columns = [
                                ...
                                ['label' => 'Message', 'column' => 'brand', 'sort' => false],
                                ['label' => 'Actions', 'column' => 'action', 'sort' => false],
                            ];
                        @endphp

                        <x-utility.table :columns="$columns" :data="$enquiries" :checkAll=false :route="route('enquiries')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are you sure you want to delete this?')"
                                            href="{{ route('enquiry.delete', $item->id) }}">

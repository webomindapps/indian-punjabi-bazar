                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Update Source" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-10 mx-auto">
                    <div class="form-section">
                        <form action="{{ route('productsource.edit', $source->id) }}" method="POST"
                            ...
                            <div class="form-contents">
                                <div class="row mb-2">
                                    ...
                                    <x-utility.forms.input label="Source" type="text" name="source" id="source"
                                        :required="true" size="col-lg-6" :value="$source->source" />
                                </div>
                            </div>

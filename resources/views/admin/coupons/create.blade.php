                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Add Coupon" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-contents">
                                <div class="row my-2">
                                    ...
                                    <x-utility.forms.input label="Discount type value" type="number"
                                        ...
                                        size="col-lg-6" :value="old('discount_type_value')" class="" />
                                    ...
                                    <x-utility.forms.select label="Is condition for discount" :options="[['label' => 'Yes', 'value' => 1], ['label' => 'No', 'value' => 0]]"
                                        ...
                                        size="col-lg-12" :value="old('is_condition_coupon')" />

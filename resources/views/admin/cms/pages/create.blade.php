                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Add Page" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('page.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-contents">
                                <div class="row my-2">
                                    ...
                                    <x-utility.forms.input label="Position" type="number" name="position" id="position"
                                        :required="true" size="col-lg-6" :value="old('position')" class="" />
                                    <x-utility.forms.input label="Title of description" type="text" name="title"
                                        id="title" :required="true" size="col-lg-12" :value="old('title')"
                                        class="" />

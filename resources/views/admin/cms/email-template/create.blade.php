                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Add Email template" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="form-section">
                        <form action="{{ route('email-template.create') }}" method="POST"
                            ...
                            <div class="form-contents">
                                <div class="row my-2">
                                    ...
                                    <x-utility.forms.input label="Title" type="text" name="title" id="title"
                                        :required="true" size="col-lg-6" :value="old('title')" class="" />
                                    <x-utility.forms.input label="Subject" type="text" name="subject" id="subject"
                                        :required="true" size="col-lg-6" :value="old('subject')" class="" />
                                    <x-utility.forms.input label="From Email Id" type="text" name="from_id"
                                        id="from_id" :required="true" size="col-lg-6" :value="old('from_id')"
                                        class="" />
                                    <x-utility.forms.input label="From name" type="text" name="from_name"
                                        id="from_name" :required="true" size="col-lg-6" :value="old('from_name')"
                                        class="" />
                                    <x-utility.forms.input label="CC" type="text" name="cc" id="cc"
                                        :required="true" size="col-lg-12" :value="old('cc')" class="" />

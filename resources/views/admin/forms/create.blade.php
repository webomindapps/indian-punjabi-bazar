                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Add Form" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-10 mx-auto">
                    <div class="form-section">
                        <form action="{{ route('productform.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-contents">
                                <div class="row mb-2">
                                    ...
                                    <x-utility.forms.input label="Form" type="text" name="form" id="form"
                                        :required="true" size="col-lg-6" :value="old('form')" />
                                </div>
                            </div>

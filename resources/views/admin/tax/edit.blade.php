                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Edit Tax" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="form-section">
                        <form action="{{ route('tax.edit', $tax->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-contents">
                                <div class="row my-2">
                                    ...
                                    <x-utility.forms.input label="Title" type="text" name="title" id="title"
                                        :required="true" size="col-lg-12" :value="$tax->title" class="" />
                                    <x-utility.forms.select label="Status" :options="Punjabi::getStatus()" name="status"
                                        id="status" :required="true" size="col-lg-6" :value="$tax->status" />

                                    <x-utility.forms.input label="Tax (in percent)" type="number" name="percent"
                                        id="percent" :required="true" size="col-lg-6" :value="$tax->percent"
                                        class="" />
                                    <x-utility.forms.textarea label="Description" name="description" :required="false"
                                        size="col-lg-12" :value="$tax->description" />
                                </div>
                            </div>

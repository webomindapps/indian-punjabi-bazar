                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-center ">
                            ...
                            <x-utility.additional.title title="Add Flavour" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-10 mx-auto">
                    <div class="form-section">
                        <form action="{{ route('flavour.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-contents">
                                <div class="row mb-2">
                                    ...
                                    <x-utility.forms.input label="Flavour" type="text" name="flavour" id="flavour"
                                        :required="true" size="col-lg-6" :value="old('flavour')" />
                                </div>
                            </div>

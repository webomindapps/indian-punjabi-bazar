                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 70%; background: #ffffff; font-family: Arial,Helvetica,sans-serif; font-size: 22px; color: #78a659; padding: 10px;"
                                    align="right">
                                    Thank You For Your Online Order, <br />
                                    <span style="color: #000;"> Your Order Number : #VS-{{ $order->id }}<br /></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr style="height: 385px;">
                                <td style="height: 385px;" bgcolor="#ffffff">
                                                ...
                                                <td valign="top">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            ...
                                                            <tr style="height: 30px; background: #fff; color: #484848;">
                                                                <td style="border-right: #ebebeb solid 1px; border-bottom: 1px solid #ebebeb; padding-left: 10px;"
                                                                    width="26%"><strong>Zip Code</strong></td>
                                                                <td
                                                                    style="padding-left: 10px; border-bottom: 1px solid #ebebeb;">
